export type ProjectStatus = 'scheduled' | 'in-progress' | 'completed' | 'on-hold' | 'cancelled';
...
export const installers: Installer[] = [
  { id: 'inst-1', name: 'Erik Lindberg', color: 1, type: 'own' },
  { id: 'inst-2', name: 'Anna Svensson', color: 2, type: 'own' },
  { id: 'inst-3', name: 'MontageTeam AB', color: 3, type: 'sub-vendor' },
  { id: 'inst-4', name: 'Karl Johansson', color: 4, type: 'own' },
  { id: 'inst-5', name: 'Nordic Install Co', color: 5, type: 'sub-vendor' },
  { id: 'inst-6', name: 'Sofia Bergström', color: 6, type: 'own' },
];
...
export const projects: Project[] = [
  ...
  { id: 'proj-3', name: 'H&M Flagship Refit', client: 'H&M', location: 'Drottninggatan', status: 'in-progress', assigneeId: 'inst-3', startDate: d(-5), endDate: d(1) },
  ...
  { id: 'proj-8', name: 'Bauhaus Garden Center', client: 'Bauhaus', location: 'Arninge', status: 'scheduled', assigneeId: 'inst-2', startDate: d(6), endDate: d(12) },
  ...
  { id: 'proj-10', name: 'Kjell & Co Tech Wall', client: 'Kjell & Company', location: 'Täby', status: 'in-progress', assigneeId: 'inst-4', startDate: d(-1), endDate: d(5) },
];
